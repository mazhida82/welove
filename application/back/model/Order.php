...
class Order extends model {
    ...
    public static $arrStatus = [1 => '未支付', 2 => '已支付', 3 => '已退款', 4 => '用户取消', 5 => '用户删除',6=>'申请退款',7=>'快速退款'];
    /*public static $arrType = [1 => '普通', 3 => '限人', 4 => '商家订金', 5 => '商家全款', 6 => '限人尾款'];*/

    public function getStAttr($value) {
        $status = ['0' => '管理员删除', 1 => '未支付', 2 => '已支付', 3 => '已退款', 4 => '用户取消', 5 => '用户删除',6=>'申请退款',7=>'快速退款'];
        return $status[$value];
    }
    ...
    public function getGoodstAttr($value) {
        $status = [1 => '未发货', 2 => '已发货', 5 => '部分发货', 3 => '已收货'];
        return $status[$value];
    }
